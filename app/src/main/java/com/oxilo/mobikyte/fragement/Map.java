 ...
 */
public class Map extends Fragment implements GoogleMap.OnMyLocationButtonClickListener, GoogleMap.OnMapClickListener,GoogleMap.OnMarkerDragListener,GoogleMap.OnCameraChangeListener
{
...
//        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(marker.getPosition(), 12));
    ...
    public void onCameraChange(CameraPosition cameraPosition) {
        mListener.onCameraUpdate(cameraPosition, mMap);
    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onCameraUpdate(CameraPosition cameraPosition,GoogleMap map);
...
//                    mMap.setOnCameraChangeListener(Map.this);
