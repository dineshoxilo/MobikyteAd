...
import com.oxilo.mobikyte.activity.WelcomeActivity;
...
//    Toolbar toolbar;
    ...
    public static ThankYou newInstance(UserCampaign userCampaign, ModalAddCampign modalAddCampign, ModalLogin modalLogin, ModalCheckOut modalCheckOut,Plan modalPlan) {
...
//        ((AppCompatActivity)getActivity()).getSupportActionBar().setHomeAsUpIndicator(R.drawable.ic_action_menu);
        ...
        TextView inrID = (TextView)view.findViewById(R.id.inr_id);
        ...
        compaignTitleView=(CustomTextView)view.findViewById(R.id.action_campaign_tittle1);
        promotionMessageView=(CustomTextView)view.findViewById(R.id.action_promotion_message1);
        ...
        if (listCamp != null){
            try {
                ...
                String df = listCamp.getCampName();
