...
import com.oxilo.mobikyte.MODAL.CustomModel;
...
//        userLoginLaunchMainActivity();
    ...
    private void userLoginLaunchMainActivity(){
        ...
        if (mobiKytePrefs.getObject("user",ModalLogin.class)!=null){
            if (mobiKytePrefs.getObject("user",ModalLogin.class).getEmailid().equals("")){
                final Intent intent = new Intent(SplashScreen.this, LoginActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                ActivityTransitionLauncher.with(SplashScreen.this).from(getWindow().getDecorView().getRootView()).launch(intent);
            }else{
